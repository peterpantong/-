...
깨비봇 폴더로 이동해서 띄운다. **시작한 폴더가 작업 범위가 된다.**
...
깨비봇이 뽑은 테마주 스크리닝 결과를 걸러내는 절차는 [THEME-REVIEW.md](THEME-REVIEW.md)에
따로 정리해 두었다. 두 PC를 오가며 쓸 거면 [TWO-MACHINES.md](TWO-MACHINES.md)도 같이 본다.
